...
\vskip -2ex
\end{figure}
\textls[-10]{Na konci nečeká tůň s vodou spásnou, \noprint{\\}na konci poslední naděje zhasnou,}\\
\begin{figure}[h!]
\vskip 2ex
\includegraphics[width=365pt ]{res/sloni3-5.pdf}
\vskip -2ex
\end{figure}
už vím, kde leží sloní hřbitov, \noprint{\\}vím, kde najdeš kosti sluncem\noexport{\\}
\begin{figure}[h!]
\vskip 2ex
...
\vskip -2ex
\end{figure}
Až nám hvězdy přestanou svítit, až nám slunce přestane hřát,\\
\begin{figure}[h!]
\vskip 2ex
\includegraphics[width=365pt ]{res/sloni3-9.pdf}
\vskip -2ex
\end{figure}
až se budeme vesmírem řítit, napořád\ldots{}\\
\begin{figure}[h!]
\vskip 2ex
\includegraphics[width=365pt ]{res/sloni3-8.pdf}
\vskip -2ex
\end{figure}
Až mi hvězdy přestanou svítit, až mi slunce přestane hřát,\\
\begin{figure}[h!]
\vskip 2ex
\includegraphics[width=365pt ]{res/sloni3-9.pdf}
\vskip -2ex
\end{figure}
chci se s vámi vesmírem řítit, napořád,\noexport{\\}
\begin{figure}[h!]
\vskip 2ex
